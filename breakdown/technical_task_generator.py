        ...
        for idx, task_dict in enumerate(parsed_tasks, 1):
            try:
                ...
                task = TechnicalTask(
                    ...
                    performance_impact=task_dict.get("performance_impact", "No significant performance impact expected"),
                    scalability_considerations=task_dict.get("scalability_considerations", "No specific scalability considerations identified"),
